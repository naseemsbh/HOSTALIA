...
$query = "SELECT id, lname, name, email, address, password, phone_no  FROM owners WHERE approval_status = 'approved'";
                ...
                <tbody>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                         ...
                         <td>   <a class="button delete" href="delete_owner.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this Owner?');">Remove</a></td>
