...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    $stmt = $con->prepare("SELECT  password FROM admins WHERE email = ?");
    ...
    if ($stmt->num_rows > 0) {
        ...
        if ($password == $stored_password) {
            ...
            echo "<script>alert('Login successful'); window.location.href='Hadmin.php';</script>";
            exit;
        } else {
        ...
        echo "<script>alert('No user found with that email address'); window.location.href='Admin-login.php';</script>";
        exit;
    }
...
<head>
    <meta charset="UTF-8">
    <title>Login</title>
    <link rel="stylesheet" href="Login-adm1.css">
    ...
    <div class="container">
        <div class="form-box">
            ...
            <form id="form" action="Admin-login.php" method="post">
                ...
                <div class="btn-field">
                    <button type="button" id="StudentBtn" class="disable" onclick="redirectToStudent()">Student</button>
                    <script>
                ...
                <div class="Register-link">
                    <p>Don't have an account? <a href="Register-ownr.php"><b>Register</b></a></p>
                </div>
            </form>
        </div>
    </div>
